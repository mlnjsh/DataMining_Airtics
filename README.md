...
`Assessment_Solutions/EDA/` holds a detailed EDA of both assignment datasets: `EDA_Task1_Task2.R` (the analysis), `EDA_Output.txt` (console output), `plots/` (12 figures), and `EDA_Report.md` / `EDA_Report.docx` (the written report with interpretation and actionable insights for each dataset).
